...
public class MainLayout extends AppLayout {
    ...
    public MainLayout() {
        ...
        final RouterLink focusTreeCustomDP = new RouterLink("Focus TreeGrid view (custom data provider)", SelectionTreeGridViewWithCustomDataProvider.class);
        ...
        final VerticalLayout menuLayout = new VerticalLayout(simple, beanGrid, selectionTreeGrid, focus,
            focusHeader, focusTree, focusTreeCustomDP, focusHTree, filter, selectableText,
            lazy, lazyFocus);
